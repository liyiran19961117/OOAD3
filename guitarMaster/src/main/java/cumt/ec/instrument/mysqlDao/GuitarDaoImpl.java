package cumt.ec.instrument.mysqlDao;
...
import cumt.ec.util.MysqlConnection;
...
public class GuitarDaoImpl implements GuitarDao {
	...
	private MysqlConnection jdbc = null;  // �������ݿ����Ӷ���
	public  GuitarDaoImpl(){
		jdbc = new MysqlConnection();
		connection = jdbc.con; // ���ù��췽��ȡ�����ݿ�����
	}
	@SuppressWarnings({ })
